...
def generate_mels(hparams, checkpoint_path, sentences, speaker_id, trans_con, logvar, cleaner, removing_silence_mel_padding, adding_silence_mel_padding, is_GL, output_dir=""):
    ...
    for i, s in enumerate(sentences):
        ...
        if trans_con == 0:
            ...
            ref = True
        _, mel_outputs_postnet, _, alignments = model.inference(sequence, refence_mel, ref_length, condition_on_ref=ref, logvar=logvar)
...
def run(hparams, output_dir, checkpoint_path, sentence_path, speaker_id, logvar, clenaer, removing_silence_mel_padding,
    ...
    mels = generate_mels(hparams, checkpoint_path, sentences, speaker_id, logvar, clenaer,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-lv', '--logvar', type=int, default=0,
                        required=False, help='logvar')
    ...
    run(hparams, args.output_directory, args.checkpoint_path, args.sentence_path, args.speaker_id, args.trans_con, args.logvar, hparams.text_cleaners,
